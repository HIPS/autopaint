...
from autopaint.neuralnet import make_gaussian_nn, make_classification_nn,make_binary_nn
...
if __name__ == '__main__':
   ...
   # Build likelihood model.
    ...
    decoder = run_variational_network(train_labels,N_weights_dec,decoder,decoder_log_like,trained_weights,all_mean)
