...
from autopaint.util import WeightsParser, load_and_pickle_binary_mnist,create_banded_cov,build_logprob_mvn
...
if __name__ == '__main__':
   ...
   # Optimize a random image to maximize this likelihood.
    cur_class = 7
    start_image = np.random.multivariate_normal(all_mean,1000*all_cov)
    # quick_grad_check(data_L, start_image)

    def callback(image):
        print "Cur loglik: ",model_ll(image,cur_class)
